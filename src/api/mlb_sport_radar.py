...
class MlbSportRadar:
    ...
    def get_all_players_with_college(self) -> List[PlayerDraft]:
        ...
        for team in team_ids:
            ...
            full_url = BASE_URL + MLB_BASE_URL + roster_url
            response = self.api_client.make_request(url=full_url)
